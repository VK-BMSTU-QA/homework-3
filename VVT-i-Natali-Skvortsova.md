...
- [ ] Меню профиля, личные данные. При нажатии на элемент "личныее данные" в меню "профиль" происходит редирект на страницу /profile
- [ ] Меню профиля, мои заказы. При нажатии на элемент "мои заказы" в меню "профиль" происходит редирект на страницу /orderHistory
- [ ] Меню профиля, выход. При нажатии на элемент "выход" в меню "профиль" происходит выход из аккаунта пользователя
...
- [ ] Открытие пустой корзины. при кустой корзине пользователя, при нажатии на элемент корзины ничего не происходит
